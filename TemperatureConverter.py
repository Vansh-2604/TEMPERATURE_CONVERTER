...
convertVar.set("Fahrenheit")  # Corrected the spelling of "Fahrenheit"

s = ttk.Style()
s.configure("unit.TMenubutton", background=SECONDARY_COLOR, relief="flat")
...
unitMenu = ttk.OptionMenu(leftFrame, unitVar, "C", "C", "F", "K", style="unit.TMenubutton")  # Corrected the OptionMenu definition
